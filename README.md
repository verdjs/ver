<img src="images/verdisbanner.jpg">
  <p align="center">
    verdis; an open source game website that hosts 350+ games with customisable settings, full rehosting support and a beautiful design
    <br/>
    <a href="https://verdis.reveriestudios.online/">view demo</a>
    ·
    <a href="https://github.com/verdjs/verdis/issues/new/choose">report issues / request feature</a>
    ·
    <a href="https://discord.gg/ZyZDmx3zuQ">discord</a>
    <br>
    <br>
    <img src="https://img.shields.io/github/repo-size/verdjs/verdis?style=for-the-badge&labelColor=%23000000&color=%231c1c1c">
    <img src="https://img.shields.io/github/stars/verdjs/verdis?style=for-the-badge&labelColor=%23000000&color=%231c1c1c">
    <img src="https://img.shields.io/github/forks/verdjs/verdis?style=for-the-badge&labelColor=000000&color=1c1c1c">
  </p>
...
- **mobile:** an exclusive page dedicated to mobile users, featuring mobile games and the same functional experience as normal verdis
- **and more!** a hosting page with details on how to clone verdis, a full update log, open blank + more
...
## repurposing
verdis is completely open source which allows you to inspect any element of the site on github, as well as being able to download assets for yourself.
...
tldr; take anything game/app you want without credit!! add/modify verdis if you want, however don't replace my credit on the actual site if you can

## contributing
you can contribute to verdis in multiple ways by [raising issues on the github](https://github.com/verdjs/verdis/issues/new/choose), which can include:
- **game suggestions:** suggest games to be added to verdis! provide a link if possible to the game to make it easier to add
